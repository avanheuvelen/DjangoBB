...
def set_theme_style(user):
    ...
    if user.is_authenticated():
        ...
        theme_style = '<link rel="stylesheet" type="text/less" href="%(static_url)sless/forum_%(theme)s.less" />' 
    else:
        theme_style = '<link rel="stylesheet" type="text/less" href="%(static_url)sless/forum.less" />'
